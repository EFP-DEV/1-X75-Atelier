...
| **Niveau 2 – Intermédiaire**  | - Organiser le contenu avec des conteneurs et formulaires<br>- Utiliser des attributs globaux                        | **Tableaux** : `table`, `tr`, `td`, `th`<br>**Formulaires** : `form`, `input`, `textarea`, `button`, `select`, `label`<br>**Attributs globaux** : `class`, `id`, `data-*` |
